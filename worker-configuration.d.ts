/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: a5e8be56f78227dadd73c853abd7a103)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CONTACT_TO" | "CONTACT_FROM">> {}
}
